...
Sweet.create!(:month => 8, :name => "", :description => "")
Sweet.create!(:month => 7, :name => "索餅", :description => "")
Sweet.create!(:month => 7, :name => "土用餅", :description => "")
Sweet.create!(:month => 6, :name => "水無月", :description => "")
Sweet.create!(:month => 6, :name => "氷室饅頭", :description => "")
Sweet.create!(:month => 5, :name => "柏餅", :description => "")
Sweet.create!(:month => 5, :name => "ちまき", :description => "")
...
Sweet.create!(:month => 2, :name => "", :description => "")
Sweet.create!(:month => 1, :name => "花びら餅", :description => "お正月のお餅です。")
