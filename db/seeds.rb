...
Sweet.create!(:month => 8, :name => "", :description => "")
Sweet.create!(:month => 7, :name => "索餅", :description => "奈良・平安期に中国から伝来した唐菓子のひとつで、七夕に索餅を食べると疫病にかからないと言われた。")
Sweet.create!(:month => 7, :name => "土用餅", :description => "土用は立春・立夏・立秋・立冬前の１８日間のこと。季節の変わり目であることから、精のつくものを食べる風習があり、和菓子では土用餅を食べる。")
Sweet.create!(:month => 6, :name => "水無月", :description => "明治以降、この時期、主に京都で食べられる菓子。上の小豆は、邪気払いの意味。下の三角形の外郎は、氷室の節句の氷の見立てなどとされている。")
Sweet.create!(:month => 6, :name => "氷室饅頭", :description => "6月1日の氷室の節句にちなむ。白は清浄、赤は厄除け、緑は健康など色の意味については諸説ある。")
Sweet.create!(:month => 5, :name => "柏餅", :description => "5月5日端午の節句の日、主に関東で食べられる。柏の葉は昔、神への供物の食器として使われた。")
Sweet.create!(:month => 5, :name => "ちまき", :description => "5月5日端午の節句の日、主に関西で食べられる。ちまきを菓子として作るようになったのは、江戸時代から。")
